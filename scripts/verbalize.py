...
["goto_waypoint tiago reading_zone common_zone","deviation tiago human_8","deviation tiago human_1","goto_waypoint tiago common_zone corridor","failure tiago passing door_3 closed","open tiago door_3","pass_through tiago door_3","fetch tiago book information_desk","failure tiago fetching coffee coffee_table too_high","ask_for_help tiago human_9","goto_waypoint tiago social_room corridor","goto_waypoint tiago corridor common_zone","deviation tiago human_1","goto_waypoint tiago common_zone reading_zone"],
["goto_waypoint tiago information_desk_zone common_zone","deviation tiago human_4","deviation tiago human_5","goto_waypoint tiago common_zone corridor","failure tiago passing door_3 closed","open tiago door_3","pass_through tiago door_3","fetch tiago book information_desk","failure tiago fetching coffee coffee_table too_far","ask_for_help tiago human_9","goto_waypoint tiago social_room corridor","goto_waypoint tiago corridor common_zone","goto_waypoint tiago common_zone information_desk_zone"]]
...
explanation_levels = ["no exp","descriptive","suggestive","counterfactual"]

# possible actions: goto_waypoint, pass_through, pass_between, open, fetch, ask_for_help, failure, deviation 

abstraction_level = abstraction_levels[3]
specificity_level = specificity_levels[1]
explanation_level = explanation_levels[0]
